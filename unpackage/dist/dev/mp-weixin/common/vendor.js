...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__51A7106",
    appName: "canteen-program-1",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initRuntimeSocketService() {
  const hosts = "192.168.140.130,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_fqKeqg";
...
const pages = [
  ...
  {
    path: "pages/source_post/source_post",
    style: {
      navigationBarTitleText: "原贴"
    }
  },
  {
...
const b = true, E = "mp-weixin", A = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = E, C = T('{"address":["127.0.0.1","192.168.140.130"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","D:/H-builderx/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"canteen-program-1","spaceId":"mp-ad47c7bd-10fe-4cc5-9ad0-a7ff552214bc","clientSecret":"4aFJdlGgksTyg+k1HJlnyQ==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__51A7106";
} catch (e2) {
...
(function(module2, exports2) {
  (function(root, factory) {
    ...
    if (root.PubSub) {
      PubSub2 = root.PubSub;
      index.__f__("warn", "at node_modules/pubsub-js/src/pubsub.js:15", "PubSub already loaded, using existing version");
    } else {
      root.PubSub = PubSub2;
      factory(PubSub2);
    }
    ...
    PubSub2.unsubscribe = function(value) {
      var descendantTopicExists = function(topic) {
        var m3;
        for (m3 in messages) {
          if (Object.prototype.hasOwnProperty.call(messages, m3) && m3.indexOf(topic) === 0) {
            return true;
          }
        }
        return false;
      }, isTopic = typeof value === "string" && (Object.prototype.hasOwnProperty.call(messages, value) || descendantTopicExists(value)), isToken = !isTopic && typeof value === "string", isFunction2 = typeof value === "function", result = false, m2, message, t2;
      if (isTopic) {
        PubSub2.clearSubscriptions(value);
        return;
      }
      for (m2 in messages) {
        if (Object.prototype.hasOwnProperty.call(messages, m2)) {
          message = messages[m2];
